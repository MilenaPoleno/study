...
//1е решение если это генерирует программа (воставила ограничение на двухзначные числа, чтобы не было огромных полотен :))
...
//2e решение если это ввод пользрвателем
